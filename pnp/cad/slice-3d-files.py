...
#	f.close()
	...
	print(base)
	subprocess.call(["/home/runner/work/index/index/PrusaSlicer.AppImage","--load","PrusaSlicerConfig.ini","--info","--output",base+"_{used_filament}_{extruded_volume}_{print_time}.gcode", "-g", base ])
